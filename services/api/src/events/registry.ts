...
export const EVENT_TYPES: EventTypeDef[] = [
  ...
  { name: "document.requested", family: "document", customer_visible: true, built: true },
  { name: "document.received", family: "document", customer_visible: true, built: true },
  { name: "document.validated", family: "document", customer_visible: true, built: true },
  { name: "document.rejected", family: "document", customer_visible: true, built: true },
  ...
  { name: "registration.readiness_changed", family: "registration", customer_visible: false, built: true },
  { name: "registration.availability_confirmed", family: "registration", customer_visible: true, built: true },
  { name: "registration.scheduled", family: "registration", customer_visible: true, built: true },
  { name: "registration.rescheduled", family: "registration", customer_visible: true, built: true },
  { name: "registration.executed", family: "registration", customer_visible: false, built: true },
  ...
  { name: "specification.baseline_approved", family: "specification", customer_visible: false, built: true },
  { name: "drawing.released", family: "specification", customer_visible: true, built: true },
  { name: "spec_revision.superseded", family: "specification", customer_visible: true, built: true },
  { name: "as_built.recorded", family: "specification", customer_visible: false, built: true },
  { name: "template.version_approved", family: "document", customer_visible: false, built: true },
  { name: "clause.version_approved", family: "document", customer_visible: false, built: true },
  { name: "document.generated", family: "document", customer_visible: false, built: true },
  { name: "document.version_created", family: "document", customer_visible: false, built: true },
  { name: "document.review_rejected", family: "document", customer_visible: false, built: true },
  { name: "document.deviation_raised", family: "document", customer_visible: false, built: true },
  { name: "document.deviation_approved", family: "document", customer_visible: false, built: true },
  { name: "document.customer_review_sent", family: "document", customer_visible: true, built: true },
  { name: "document.approved_for_execution", family: "document", customer_visible: false, built: true },
  { name: "document.executed", family: "document", customer_visible: true, built: true },
  { name: "document.finalised", family: "document", customer_visible: true, built: true },
  { name: "document.archived", family: "document", customer_visible: false, built: true },
  { name: "change_request.created", family: "change_request", customer_visible: true, built: true },
  { name: "change_request.status_changed", family: "change_request", customer_visible: true, built: true },
  { name: "change_request.feasibility_recorded", family: "change_request", customer_visible: false, built: true },
  { name: "change_request.quotation_issued", family: "change_request", customer_visible: true, built: true },
  { name: "change_request.quotation_accepted", family: "change_request", customer_visible: true, built: true },
  { name: "change_request.payment_waived", family: "change_request", customer_visible: false, built: true },
  { name: "change_request.released", family: "change_request", customer_visible: true, built: true },
  { name: "change_request.qa_verified", family: "change_request", customer_visible: false, built: true },
  { name: "change_request.customer_accepted", family: "change_request", customer_visible: true, built: true },
  { name: "change_request.as_built_closed", family: "change_request", customer_visible: true, built: true },
  { name: "change_request.cancelled", family: "change_request", customer_visible: true, built: true },
  ...
  { name: "handover.scheduled", family: "handover", customer_visible: true, built: true },
  { name: "handover.completed", family: "handover", customer_visible: true, built: true },
  { name: "handover.gate_evaluated", family: "handover", customer_visible: false, built: true },
  { name: "handover.gate_overridden", family: "handover", customer_visible: false, built: true },
  { name: "handover.appointment_confirmed", family: "handover", customer_visible: true, built: true },
  { name: "handover.appointment_rescheduled", family: "handover", customer_visible: true, built: true },
  { name: "handover.closed", family: "handover", customer_visible: false, built: true },
  { name: "warranty.case_opened", family: "warranty", customer_visible: true, built: true },
  { name: "warranty.case_closed", family: "warranty", customer_visible: true, built: true },
  { name: "warranty.quote_issued", family: "warranty", customer_visible: true, built: true },
  { name: "warranty.quote_accepted", family: "warranty", customer_visible: true, built: true },
  { name: "post_handover.case_opened", family: "post_handover", customer_visible: false, built: true },
  { name: "post_handover.move_in_task_completed", family: "post_handover", customer_visible: false, built: true },
  { name: "post_handover.onboarding_completed", family: "post_handover", customer_visible: true, built: true },
  { name: "dlp.window_expired", family: "post_handover", customer_visible: false, built: true },
  { name: "advocacy.invited", family: "advocacy", customer_visible: false, built: true },
  { name: "advocacy.received", family: "advocacy", customer_visible: false, built: true },

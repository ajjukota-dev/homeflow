...
**Position:** R0 complete (5/5 merged), R0.5 (schema reconciliation) done, R0.6 (authorization) merged, R1 code complete (4/4 sub-lanes merged; URL smoke test still outstanding, see R1 row) · **Live URL:** https://we947t2rq2.ap-south-1.awsapprunner.com (`/health` → `{"ok":true,"db":true}` against real RDS) · **Last deploy:** 2026-09-05 R0-03 merge — R1's changes are not yet deployed there · **Last updated:** 2026-09-05 17:03 IST

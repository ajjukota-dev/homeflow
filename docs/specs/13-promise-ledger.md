...
## Files
`services/api/src/commitments/**`, `services/api/migrations/0011_commitments.sql`, `services/api/src/handover.ts` (gate input only), `apps/workspace/src/pages/PromiseLedger*.tsx`, `apps/workspace/src/components/CommitmentDrawer.tsx`, analytics page.

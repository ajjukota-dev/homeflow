...
## Files
`services/api/src/escalations/**`, `services/api/src/notifications/**`, `services/api/migrations/0010_escalations.sql`, `services/api/src/seed/escalation-rules.ts`, `apps/workspace/src/pages/Escalations*.tsx`, `apps/workspace/src/components/NotificationBell.tsx`, `apps/workspace/src/pages/Preferences.tsx`, Studio tabs.
